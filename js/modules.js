...
function adjustStock(id,qty){const amount=prompt(`Quantidade a ${qty>0?'adicionar':'remover'}:`,Math.abs(qty));if(amount!==null && amount > 1){Supplies.adjustStock(id,qty>0?parseInt(amount):-parseInt(amount));toast('Estoque ajustado!');renderSuprimentos()}}
